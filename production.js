  ...
  const getPosts1 = async () => {
    try {
      const res_MC01 = await axios.get(
        api_Influx +
          "/query?pretty=true&db=influx&q=SELECT OUTPUT,CT,UTL,M34%20FROM%20%22sensors%22%20WHERE%20mc_no%20=%20%27MC01%27%20ORDER%20BY%20time%20desc%20limit%201"
      );
            ...
            <div className="row">
              <div className="col-lg-3 col-6">
                <div className="small-box bg-success" style={divStyle4}>
                  <div className="inner">
                    {/* <h3 style={divStyle1}>{datas_MC01.TL_OUT_A}</h3> */}
                    <h3 style={divStyle1}>
                      123 <sub style={divStyle5}>pcs</sub>
                    </h3>
                  </div>
